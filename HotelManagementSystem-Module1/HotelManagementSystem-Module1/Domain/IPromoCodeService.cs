...
namespace HotelManagementSystem.Domain
{
    public interface IPromoCodeService
    {
        ...
        /// <summary>
        /// Search and retrieve the existing promo code by promo code input
        /// </summary>
        ...
        /// </summary>
        /// <param name="promoCode">The Id of promo code</param>
        ...
        /// </summary>
        /// <param name="promoCode">The promo code object</param>
